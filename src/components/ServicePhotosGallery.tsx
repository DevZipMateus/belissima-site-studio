...
const ServicePhotosGallery = () => {
  const images = [
    "/fotos e video/servico-1.jpeg",
    "/fotos e video/servico-2.jpeg", 
    "/fotos e video/servico-3.jpeg",
    "/fotos e video/servico-4.jpeg",
    "/fotos e video/servico-5.jpeg"
  ];
...
export default ServicePhotosGallery;
